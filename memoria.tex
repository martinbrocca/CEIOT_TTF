...
\juradoUNO{A ser designado} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur1name
\juradoDOS{A ser designado} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur2name
\juradoTRES{A ser designado} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur3name
...
\vspace{1.5cm}
%
A Ariadna, quien me dio la confianza y el empuje inicial para comenzar esta especialización y todo su apoyo para poder terminarla. 

A mis hijos, quienes han sabido comprender el tiempo dedicado al estudio.
...
Y muy especialmente a mi padre, por su orientación, supervisión y apoyo durante la realización del presente trabajo.
